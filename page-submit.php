	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
            ...
            <div class="quote-submission-wrapper">
                <form class="quoteForm" id="quote-submisison-form">
                ...
                <p class ="submit-success-message" syle="display:none">Thanks for the awesome quote.</p>

         </div>
            <?php else: ?>
            <p>
                Sorry, you must be logged in to submit a quote.</p>
